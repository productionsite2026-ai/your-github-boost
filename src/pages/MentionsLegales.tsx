  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Mentions légales de DogWalking SAS, plateforme de mise en relation entre Propriétaires de chiens et Accompagnateurs professionnels en France."
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground mt-4">
              ...
              contrats conclus entre les utilisateurs (Propriétaires et Accompagnateurs) et n'assume 
