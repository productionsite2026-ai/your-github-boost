...
export const servicesData: Record<string, ServiceData> = {
  "promenade-chien": {
    ...
    faq: [
      { question: "Qui sont les promeneurs DogWalking ?", answer: "Nos promeneurs sont des passionnés d'animaux rigoureusement sélectionnés. Chaque candidat passe par une vérification d'identité complète (CNI), un contrôle approfondi, et doit fournir une vérification complète professionnelle. Nous vérifions également leurs références et leur expérience avec les chiens. Seuls 20% des candidats sont acceptés après notre processus de sélection." },
  ...
  "visite-domicile": {
    ...
    expertiseAdvantages: {
      ...
      trust: "La confiance est essentielle quand on ouvre son domicile à un tiers. C'est pourquoi chaque visiteur passe par une vérification d'identité, un contrôle approfondi et doit fournir des références vérifiables. Les avis des autres Propriétaires complètent cette transparence."
    },
    advantages: [
  ...
  "garde-domicile": {
    ...
    expertiseAdvantages: {
      ...
      trust: "Ouvrir son domicile demande une confiance absolue. C'est pourquoi nos gardiens passent par une vérification d'identité complète, un contrôle approfondi et doivent fournir des références. Leurs avis vérifiés témoignent de leur fiabilité."
    },
    advantages: [
  ...
  "hebergement-chien": {
    ...
    howItWorks: {
      ...
      safety: "La sécurité de votre chien est notre priorité absolue. Toutes les familles d'accueil sont vérifiées : identité, vérification approfondie, vérification de domicile. Leur domicile est inspecté pour garantir un environnement sécurisé (jardin clôturé, absence de dangers). En cas de problème de santé, le family sitter contacte immédiatement votre vétérinaire ou une clinique de garde.",
  ...
  "garderie-chien": {
    ...
    expertiseAdvantages: {
      ...
      insurance: "Toutes les garderies partenaires disposent des protections nécessaires pour couvrir leur activité. Votre chien est protégé pendant toute la durée de sa présence. Les locaux sont conformes aux réglementations en vigueur pour l'accueil d'animaux.",
